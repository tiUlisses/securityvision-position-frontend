...
export default function CameraEventsModal({
  isOpen,
  camera,
  events,
  onClose,
  ...
  const uiEvents = useMemo(() => {
    // Mantém só eventos analíticos (tópicos /events e não-status)
              ...
              <>
                <div className="border-b border-slate-800 px-3 py-2">
                  ...
                  <div className="mt-2 flex items-center justify-between gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => onRequestCreateIncident(selectedEvent)}
